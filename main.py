...
sc.save("template/tile.png")
number = get_tile_number("template/tile.png")
new_filename = f"template/tile{number if number else 0}.png"
os.rename("template/tile.png", new_filename)
